function! statusline#themes#default#getColorMapping()
    let colorMapping = {
        ...
        \ 'user2_command_bg': 'x166_DarkOrange3',
        \ 'user2_command_fg': 'x052_DarkRed',
        ...
        \ 'user3_command_bg': 'x166_DarkOrange3',
        \ 'user3_command_fg': 'x054_Purple4',
        ...
        \ 'user4_command_bg': 'x166_DarkOrange3',
        \ 'user4_command_fg': 'x052_DarkRed',
        ...
        \ 'user5_command_bg': 'x166_DarkOrange3',
        ...
        \ 'user6_command_bg': 'x166_DarkOrange3',
        \ 'user6_command_fg': 'x052_DarkRed',
        ...
        \ 'user7_command_bg': 'x166_DarkOrange3',
        \ 'user7_command_fg': 'x233_Grey7',
