function! statusline#themes#default#getColorMapping()
    let colorMapping = {
        ...
        \ 'user1_command_fg': 'x161_DeepPink3',
        \ 'user1_search_bg': 'x166_DarkOrange3',
        \ 'user1_search_fg': 'x161_DeepPink3',
        ...
        \ 'user2_command_fg': 'x183_Plum2',
        \ 'user2_search_bg': 'x166_DarkOrange3',
        \ 'user2_search_fg': 'x052_DarkRed',
